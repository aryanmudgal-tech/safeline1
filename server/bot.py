...
"""Safeline — police documentation voice agent (GPT variant).
...
function tools registered on the LLM context. The pipeline, Twilio transport,
and Pipecat Cloud deploy are unchanged from the starter kit — only the business
logic (system prompt + tools) has been swapped, in ``police_agent.py``.
